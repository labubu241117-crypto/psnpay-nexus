...
const t: Translations = {
  ...
  "home.articles": { id: "Artikel Terbaru", en: "Latest Articles", ms: "Artikel Terkini", zh: "最新文章", ar: "أحدث المقالات", ja: "最新記事", ko: "최신 기사", th: "บทความล่าสุด" },
  "home.readMore": { id: "Baca selengkapnya", en: "Read more", ms: "Baca lagi", zh: "阅读更多", ar: "اقرأ المزيد", ja: "続きを読む", ko: "더 읽기", th: "อ่านเพิ่มเติม" },
  "home.minRead": { id: "menit baca", en: "min read", ms: "minit baca", zh: "分钟阅读", ar: "دقائق للقراءة", ja: "分で読める", ko: "분 소요", th: "นาทีในการอ่าน" },
  "home.article1Title": { id: "Tips Mengelola Keuangan Digital dengan Bijak", en: "Tips for Managing Digital Finance Wisely", ms: "Tips Mengurus Kewangan Digital dengan Bijak", zh: "明智管理数字财务的技巧", ar: "نصائح لإدارة التمويل الرقمي بحكمة", ja: "デジタルファイナンスを賢く管理するコツ", ko: "디지털 금융을 현명하게 관리하는 팁", th: "เคล็ดลับจัดการการเงินดิจิทัลอย่างชาญฉลาด" },
  "home.article1Desc": { id: "Pelajari cara mengatur pengeluaran dan menabung secara efektif menggunakan dompet digital.", en: "Learn how to manage spending and save effectively using digital wallets.", ms: "Pelajari cara mengatur perbelanjaan dan menabung secara efektif menggunakan dompet digital.", zh: "学习如何使用数字钱包有效管理支出和储蓄。", ar: "تعلم كيفية إدارة الإنفاق والادخار بفعالية باستخدام المحافظ الرقمية.", ja: "デジタルウォレットを使って支出管理と効果的な貯蓄の方法を学びましょう。", ko: "디지털 지갑을 사용하여 지출을 관리하고 효과적으로 저축하는 방법을 알아보세요.", th: "เรียนรู้วิธีจัดการค่าใช้จ่ายและออมเงินอย่างมีประสิทธิภาพด้วยกระเป๋าเงินดิจิทัล" },
  "home.article2Title": { id: "Keuntungan Bergabung dengan Koperasi Digital", en: "Benefits of Joining a Digital Cooperative", ms: "Keuntungan Menyertai Koperasi Digital", zh: "加入数字合作社的好处", ar: "فوائد الانضمام إلى تعاونية رقمية", ja: "デジタル協同組合に参加するメリット", ko: "디지털 협동조합 가입의 장점", th: "ข้อดีของการเข้าร่วมสหกรณ์ดิจิทัล" },
  "home.article2Desc": { id: "Temukan bagaimana koperasi digital dapat membantu UMKM berkembang di era modern.", en: "Discover how digital cooperatives can help MSMEs grow in the modern era.", ms: "Ketahui bagaimana koperasi digital boleh membantu UMKM berkembang di era moden.", zh: "了解数字合作社如何帮助中小企业在现代化时代成长。", ar: "اكتشف كيف يمكن للتعاونيات الرقمية مساعدة المشاريع الصغيرة على النمو.", ja: "デジタル協同組合がどのように中小企業の成長を支援できるか発見しましょう。", ko: "디지털 협동조합이 어떻게 중소기업의 성장을 도울 수 있는지 알아보세요.", th: "ค้นพบว่าสหกรณ์ดิจิทัลช่วยให้ SME เติบโตในยุคใหม่ได้อย่างไร" },
  "home.article3Title": { id: "Panduan Lengkap Transaksi QRIS untuk Pemula", en: "Complete QRIS Transaction Guide for Beginners", ms: "Panduan Lengkap Transaksi QRIS untuk Pemula", zh: "初学者完整QRIS交易指南", ar: "دليل شامل لمعاملات QRIS للمبتدئين", ja: "初心者のための完全なQRIS取引ガイド", ko: "초보자를 위한 QRIS 거래 완벽 가이드", th: "คู่มือการทำธุรกรรม QRIS ฉบับสมบูรณ์สำหรับผู้เริ่มต้น" },
  "home.article3Desc": { id: "Semua yang perlu Anda ketahui tentang pembayaran menggunakan QRIS di merchant terdekat.", en: "Everything you need to know about making payments using QRIS at nearby merchants.", ms: "Semua yang anda perlu tahu tentang pembayaran menggunakan QRIS di pedagang terdekat.", zh: "您需要了解的关于在附近商户使用QRIS支付的一切。", ar: "كل ما تحتاج معرفته عن الدفع باستخدام QRIS في المتاجر القريبة.", ja: "近くの店舗でQRISを使った支払いについて知っておくべきすべてのこと。", ko: "가까운 가맹점에서 QRIS를 사용한 결제에 대해 알아야 할 모든 것.", th: "ทุกสิ่งที่คุณต้องรู้เกี่ยวกับการชำระเงินด้วย QRIS ที่ร้านค้าใกล้เคียง" },

  // ═══ News Screen ═══
  "news.title": { id: "Berita & Artikel", en: "News & Articles", ms: "Berita & Artikel", zh: "新闻与文章", ar: "الأخبار والمقالات", ja: "ニュースと記事", ko: "뉴스 및 기사", th: "ข่าวสารและบทความ" },
  "news.trending": { id: "Trending", en: "Trending", ms: "Trending", zh: "热门", ar: "رائج", ja: "トレンド", ko: "트렌딩", th: "กำลังมาแรง" },
  "news.all": { id: "Semua", en: "All", ms: "Semua", zh: "全部", ar: "الكل", ja: "すべて", ko: "전체", th: "ทั้งหมด" },
  "news.finance": { id: "Keuangan", en: "Finance", ms: "Kewangan", zh: "金融", ar: "المالية", ja: "金融", ko: "금융", th: "การเงิน" },
  "news.tech": { id: "Teknologi", en: "Technology", ms: "Teknologi", zh: "科技", ar: "التكنولوجيا", ja: "テクノロジー", ko: "기술", th: "เทคโนโลยี" },
  "news.tips": { id: "Tips", en: "Tips", ms: "Tips", zh: "技巧", ar: "نصائح", ja: "ヒント", ko: "팁", th: "เคล็ดลับ" },
  "news.promo": { id: "Promo", en: "Promo", ms: "Promosi", zh: "促销", ar: "عروض", ja: "プロモ", ko: "프로모", th: "โปรโมชั่น" },
  "news.shareArticle": { id: "Bagikan artikel", en: "Share article", ms: "Kongsi artikel", zh: "分享文章", ar: "شارك المقال", ja: "記事を共有", ko: "기사 공유", th: "แชร์บทความ" },
  "news.bookmarkArticle": { id: "Simpan artikel", en: "Bookmark article", ms: "Simpan artikel", zh: "收藏文章", ar: "حفظ المقال", ja: "記事を保存", ko: "기사 저장", th: "บุ๊กมาร์กบทความ" },
  "news.article4Title": { id: "Cara Aman Bertransaksi Online di Era Digital", en: "How to Safely Transact Online in the Digital Era", ms: "Cara Selamat Bertransaksi Online di Era Digital", zh: "数字时代安全在线交易的方法", ar: "كيفية إجراء المعاملات عبر الإنترنت بأمان", ja: "デジタル時代に安全にオンライン取引する方法", ko: "디지털 시대에 안전하게 온라인 거래하는 방법", th: "วิธีทำธุรกรรมออนไลน์อย่างปลอดภัยในยุคดิจิทัล" },
  "news.article4Desc": { id: "Lindungi data pribadi Anda dengan tips keamanan siber yang mudah diterapkan sehari-hari.", en: "Protect your personal data with easy-to-apply daily cybersecurity tips.", ms: "Lindungi data peribadi anda dengan tips keselamatan siber yang mudah digunakan.", zh: "通过简单的日常网络安全技巧保护您的个人数据。", ar: "احمِ بياناتك الشخصية بنصائح أمن سيبراني سهلة التطبيق.", ja: "毎日実践できる簡単なサイバーセキュリティのヒントで個人データを守りましょう。", ko: "일상에서 쉽게 적용할 수 있는 사이버 보안 팁으로 개인 데이터를 보호하세요.", th: "ปกป้องข้อมูลส่วนตัวด้วยเคล็ดลับความปลอดภัยไซเบอร์ที่ใช้ได้ง่าย" },
  "news.article5Title": { id: "PSNPAY Raih Penghargaan Fintech Terbaik 2025", en: "PSNPAY Wins Best Fintech Award 2025", ms: "PSNPAY Raih Anugerah Fintech Terbaik 2025", zh: "PSNPAY获得2025年最佳金融科技奖", ar: "PSNPAY تفوز بجائزة أفضل تقنية مالية 2025", ja: "PSNPAYが2025年ベストフィンテック賞を受賞", ko: "PSNPAY 2025 최우수 핀테크 수상", th: "PSNPAY คว้ารางวัลฟินเทคยอดเยี่ยม 2025" },
  "news.article5Desc": { id: "Platform pembayaran digital PSNPAY dinobatkan sebagai fintech terinovatif di Indonesia.", en: "PSNPAY digital payment platform named the most innovative fintech in Indonesia.", ms: "Platform pembayaran digital PSNPAY dinobatkan sebagai fintech paling inovatif di Indonesia.", zh: "PSNPAY数字支付平台被评为印度尼西亚最具创新性的金融科技。", ar: "منصة الدفع الرقمي PSNPAY تُسمى الأكثر ابتكارًا في إندونيسيا.", ja: "PSNPAYデジタル決済プラットフォームがインドネシアで最も革新的なフィンテックに選出。", ko: "PSNPAY 디지털 결제 플랫폼이 인도네시아에서 가장 혁신적인 핀테크로 선정되었습니다.", th: "แพลตฟอร์มการชำระเงินดิจิทัล PSNPAY ได้รับการเสนอชื่อเป็นฟินเทคที่สร้างสรรค์ที่สุดในอินโดนีเซีย" },
  "news.article6Title": { id: "Promo Cashback Spesial Ramadhan 2025", en: "Special Ramadan 2025 Cashback Promo", ms: "Promo Pulangan Tunai Khas Ramadan 2025", zh: "2025斋月特别返现促销", ar: "عرض استرداد نقدي خاص بشهر رمضان 2025", ja: "2025年ラマダン特別キャッシュバックプロモ", ko: "2025 라마단 특별 캐시백 프로모션", th: "โปรโมชั่นแคชแบ็กพิเศษรอมฎอน 2025" },
  "news.article6Desc": { id: "Nikmati cashback hingga 50% untuk semua transaksi selama bulan Ramadhan.", en: "Enjoy up to 50% cashback on all transactions during Ramadan.", ms: "Nikmati pulangan tunai sehingga 50% untuk semua transaksi semasa Ramadan.", zh: "斋月期间所有交易享受高达50%的返现。", ar: "استمتع باسترداد نقدي يصل إلى 50% على جميع المعاملات خلال شهر رمضان.", ja: "ラマダン中のすべての取引で最大50%のキャッシュバックをお楽しみください。", ko: "라마단 기간 모든 거래에서 최대 50% 캐시백을 즐기세요.", th: "เพลิดเพลินกับแคชแบ็กสูงสุด 50% สำหรับทุกรายการในช่วงรอมฎอน" },
